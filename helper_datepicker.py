...
class DateData:
    def __init__(self):
        ...
        self.dispdt.set(self.year_selected + '-' + self.month_selected + '-' + self.day_selected + ' is ' + self.day_name)
...
class Calendar:
    ...
    def selection(self, day):
        ...
        self.month_selected = self.month
        self.year_selected = self.year
        self.day_name = time.strftime("%A",time.strptime(str(day) + ' ' + str(self.month) + ' ' + str(self.year), "%d %m %Y"))
        self.data.datedataset(self.year_selected,self.month_selected,self.day_selected ,self.day_name )
    ...
    def setup(self, y, m):
        ...
        quit = tk.Button(self.parent, width=5, text='Cancel', command=lambda:self.parent.destroy())
